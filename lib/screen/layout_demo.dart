...
class LayoutDemo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(appBar: AppBar(title: Text("Exercise 3 – Layout Demo"),),
      body: Padding(
        padding: EdgeInsets.all(16),
        child: Column(
          children: [
            SizedBox(height: 10), // Tạo khoảng trống 10px
            Text("Now Playing", style: TextStyle(fontSize: 32, fontWeight: FontWeight.bold,),),
            SizedBox(height: 20),
            Expanded(  // Expanded giúp ListView chiếm// toàn bộ chiều cao còn lại
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {// Tạo từng item
                  return Padding(
                    padding:
                    EdgeInsets.only(bottom: 12),// Khoảng cách dưới mỗi Card
                    child: Card(
                      elevation: 1,
                      ...
                      child: ListTile(
                        ...
                        leading: CircleAvatar(backgroundColor: Colors.indigo.shade100, // Màu nền A,I,I,J
                          child: Text(
                            ...
                            style: TextStyle(color: Colors.indigo,//mau chữ
                            ),
                          ),
                        ),
                        title: Text(movies[index], style: TextStyle(fontSize: 20,),),
